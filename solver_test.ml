...
let tree2 = solver.buildParseTree inputExpr;;
...
let ast2 = Solver.buildAbstractSyntaxTree tree1;;
...
let varList2 = Solver.scanVariable inputExpr;;
...
let initAssign2 = Solver.generateInitialAssignList ["a";"b"];;
...
let nextAssign3 = Solver.generateNextAssignList [("a",false);("b",false)];;
let nextAssign4 = Solver.generateNextAssignList [("a",false);("b",true)];;
let nextAssign5 = Solver.generateNextAssignList [("a",true);("b",true)];;
...
if not (Solver.lookupVar [("a",false);("b",true)] "a") then print_endline "lookupVar passed" else print_endline "lookupVar failed";;

if not (Solver.evaluateTree ast1 [("a",false);("b",false)]) && Solver.evaluateTree ast1 [("a",true);("b",false)] then print_endline "evaluateTree passed" else print_endline "evaluateTree failed";;

let satResult1 = [[("a",false);("b",true)];[("a",true);("b",false)];[("a",true);("b",true)]];;
let satResult2 = Solver.satisfiable inputExpr;;
...
let satResult3 = [];;
let satResult4 = Solver.satisfiable ["(";"and";"a";"(";"not";"a";")";")"];;
...
let satResult6 = Solver.satisfiable ["(";"not";"(";"and";"(";"or";"a";"b";")";"FALSE";")";")"];;
...
let satResult8 = Solver.satisfiable ["(";"not";"(";"or";"(";"or";"(";"not";"a";")";"(";"not";"b";")";")";"(";"not";"c";")";")";")"];;
...
let satResult10 = Solver.satisfiable ["(";"and";"(";"or";"a";"(";"not";"b";")";")";"(";"or";"b";"(";"not";"a";")";")";")"];;
